...
public final class BossBar_1_8_R2 extends BarEntity<EntityWither, DataWatcher> {
    public BossBar_1_8_R2(World world, float healthPercentage, String text) {
    ...
    public static BarEntity<?, ?> create(World world, float healthPercentage, String text) {
        return new BossBar_1_8_R2(world, healthPercentage, text);
    }
}