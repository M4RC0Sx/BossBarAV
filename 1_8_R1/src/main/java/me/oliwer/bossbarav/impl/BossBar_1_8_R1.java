...
import static net.minecraft.server.v1_8_R1.MathHelper.floor;

public final class BossBar_1_8_R1 extends BarEntity<EntityWither, DataWatcher> {
    public BossBar_1_8_R1(World world, float healthPercentage, String text) {
    ...
    public static BarEntity<?, ?> create(World world, float healthPercentage, String text) {
        return new BossBar_1_8_R1(world, healthPercentage, text);
    }
}